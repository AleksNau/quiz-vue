<template>
  <div class="quiz">
    ...
    <div class="container">
      <Survey :isLoading="loading" :quizdata="quizdata[count]" :typename="quizdata[count].type"/>
      <button v-if="!maxLength" class="quiz__button" type="button" @click="makeProgress">далее</button>
      <button v-else class="quiz__button" type="button" @click="getResult">другой</button>
    </div>
  </div>
...
const quizdata = ref([
  ...
  },
  {
    ...
    image: "../../src/assets/questions/question8.jpg",
    type: "image"
  },
  {
    id: 9,
  ...
  },
  {
    ...
    image: "../../src/assets/questions/question10.jpg",
    type: "semiImage"
  },
  {
    id: 11,
    ...
    image: "../../src/assets/questions/question11.jpg",
    type: "image"
  },
]);
